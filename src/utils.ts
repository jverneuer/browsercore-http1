...
import type { Http1ConnectionId, RandomSource } from "./types.js";
 ...
 * randomness directly.
 */
export function createId(prefix: string, random: RandomSource): Http1ConnectionId {
    ...
    return `${prefix}_${Date.now().toString(36)}_${suffix.toString(36)}` as Http1ConnectionId;
}
